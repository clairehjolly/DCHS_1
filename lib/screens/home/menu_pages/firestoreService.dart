...
import 'package:project/screens/home/menu_pages/newAnimal.dart';
...
class FirestoreService {
  ...
  Future<NewAnimal> createAnimal(String name, String animalID,String age,String sex,String species,
    ...
    final TransactionHandler createTransaction = (Transaction tx) async {
      ...
      final NewAnimal task = new NewAnimal(name, animalID,age,sex,species,breed, status, location, animalPic,
