          ...
          new Container(
            ...
            child:TextField(
              ...
              decoration: InputDecoration(
                ...
                hintText: 'Enter Name',hintStyle:  TextStyle( fontFamily: 'SourceSansPro',fontWeight: FontWeight.bold),
              ),
              onChanged: (string) {
...
//                    .toList();
                  ...
                  hint: Text('Select Age',style:TextStyle(fontFamily: 'SourceSansPro', fontWeight: FontWeight.bold,)),
                ),
              ),
            ),
          ),
...
//              });
                  ...
                  hint: Text('Select Species',style: TextStyle( fontFamily: 'SourceSansPro',fontWeight: FontWeight.bold,),),
                ),
              ),
            ),
          ),
            ...
            child:DropdownButtonHideUnderline(
              child:ButtonTheme(
                ...
                child:DropdownButton(
                  ...
                  hint: Text('Select Gender',style: TextStyle( fontFamily: 'SourceSansPro',fontWeight: FontWeight.bold,)),
                ),
              ),
            ),
          ),
                                            ...
                                            onPressed: (){
                                              Navigator.push(
                                                ...
                                                MaterialPageRoute(builder: (context) => new adopt_info(a1:new NewAnimal(a1.name, a1.age, a1.sex, a1.species, a1.breed, a1.status, a1.location,
                                                    a1.animalPic, a1.description, a1.lonelyHearts, a1.adoptionFee, a1.animalID))),
                                              );//
                                            },
                                            color: Color(0xffffc50d),
                                            child: Text(
