...
class _ExpandableTextState extends State<ExpandableText> {
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(builder: (context, size) {
      ...
      child: Text(expand ? 'Collapse' : 'Read all', style: TextStyle(
      fontSize: style != null ? style.fontSize : 20.0, fontWeight: FontWeight.bold,
          decoration: TextDecoration.underline, color: Color(0xffaa295d))),
      ),
      ),
              ],
          );
