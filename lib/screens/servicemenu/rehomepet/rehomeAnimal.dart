class RehomeAnimal{
  ...
  RehomeAnimal(this.name, this.age, this.sex, this.species, this.breed, this.status, this.location,
      this.animalPic, this.description, this.lonelyHearts, this.adoptionFee);

  RehomeAnimal.map(dynamic obj){
    this.name = obj['name'];
    this.age = obj['age'];
    this.sex = obj['sex'];
  ...
  RehomeAnimal.fromMap(Map<String,dynamic> map){
    this.name= map['_name'];
    this.age = map['_age'];
    this.sex = map['_sex'];
